...
| ⬜ Planned | **7** | **[Minimal Tool-Calling Specimen](docs/weeks/week-07-specimen.md)** | Single-tool agent specimen with a pinned Strands telemetry profile, normalized execution traces, optional observed pre-tool assistant text, and controlled mock integrations. | **Instrumented Agent Specimen** — Single-tool agent with tested trace normalization, explicit null handling for absent pre-tool text, and controlled mock integrations. |
